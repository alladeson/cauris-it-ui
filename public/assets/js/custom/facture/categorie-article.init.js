...
let categorieArticle = {
    ...
    showItem: function(el) {
        ...
        categorieArticle.request(URL_GET_ITEM.replace("__id__", id), 'GET', null).then(function(data) {
            ...
            // Run this when promise was rejected via reject()
            console.log(err)
            categorieArticle.saError("Erreur !", "Une erreur s'est produite lors de l'affichage.")
        });
    },
    editItem: function(el) {
        ...
        categorieArticle.request(URL_GET_ITEM.replace("__id__", id), 'GET', null).then(function(data) {
            ...
            // Run this when promise was rejected via reject()
            console.log(err)
            categorieArticle.saError("Erreur !", "Une erreur s'est produite lors de la modification.")
        });
    },
