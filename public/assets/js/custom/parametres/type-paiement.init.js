        ...
        datatable = $(".datatable").DataTable({
                ...
                "ajax": {
                    ...
                    error: function(xhr, status, error) {
                        ...
                        GlobalScript.ajxRqtErrHandler(xhr, "alertify", "la récupération des types de paiement");
...
$(document).ready(function() {
    ...
    //     typePaiement.saRemoveParams($(this), "Êtes-vous sûr de vouloir supprimer cette catégorie d'articles ?", "Cette opération est irréversible !", "Oui, supprimer !", "Non, annuler !", "Supprimée !", "Catégorie d'articles supprimée avec succès.", "annulée !", "Opération annulée, rien n'a changé.");
    // });
