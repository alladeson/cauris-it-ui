...
$(document).ready(function() {
    ...
    //     feature.saRemoveParams($(this), "Êtes-vous sûr de vouloir supprimer cette catégorie d'articles ?", "Cette opération est irréversible !", "Oui, supprimer !", "Non, annuler !", "Supprimée !", "Catégorie d'articles supprimée avec succès.", "annulée !", "Opération annulée, rien n'a changé.");
    // });
