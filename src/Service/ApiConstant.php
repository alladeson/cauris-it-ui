...
class ApiConstant
{
   ...
   // Inventaire de stock 
    ...
    // Rapport : Liste Mouvement des articles
    public const URL_LIST_MOUVEMENT_ARTICLES = "stock/mouvement-article";
    // Rapport : Liste Mouvement Article Filtre par date
    public const URL_LIST_MOUVEMENT_ARTICLES_BY_CREATED_DATE = "stock/mouvement-article/list/created-at";
    ...
    public const URL_LIST_FACTURE_BY_TYPE = "factures/type/__typeId__/confirm/__confirm__";
    ...
    // Filtre par client
    public const URL_LIST_FACTURE_BY_CLIENT = "factures/client/__clientId__/confirm/__confirm__";
    ...
    public const URL_LIST_FACTURE_BY_CLIENT_AND_TYPE = "factures/client/__clientId__/type/__typeId__/confirm/__confirm__/all";
